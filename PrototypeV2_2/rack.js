...
export function createWorkerModel(scene) //Well, pawn model technically
{
...
export function createWorkerShadow(scene)
{
...
export function createSearchIndicator(scene)
{
...
export async function simulateRackSearch(worker, rackNumber)
{
...
export async function simulateSearch(worker,targetIDs,boxObjects)
{
...
//InitRack
export function createMedicineRack(rackNumber)
{
